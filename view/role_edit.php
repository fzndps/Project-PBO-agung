    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=role&fitur=update&id=<?php echo htmlspecialchars($role->role_id)?>" method="POST">
                <input type="hidden" name="role_id" value="<?php echo $role->role_id?>">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="role_description" name="role_description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Deskripsi Role" rows="3" required
                        ><?php echo htmlspecialchars($role->role_description)?></textarea>
                    </div>
